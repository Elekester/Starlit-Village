...
The tournament must have at least a number of rounds equal to $log_2(\text{# of rounds})$, rounded up to the nearest integer. If rounds cannot be completed, no prizes are awarded.
